        ...
        <div className="row">
          ...
          {/* <div className="footer-col">
            ...
            <div className="social-links">
              <a href="#"><i className="fab_fa-facebook-f"><FacebookIcon/></i></a>
              <a href="#"><i className="fab_fa-twitter"><InstagramIcon/></i></a>
              <a href="#"><i className="fab_fa-instagram"></i></a>
              <a href="#"><i className="fab_fa-linkedin-in"></i></a>
            </div>
          </div> */}
...
<div class="card">
  <a class="socialContainer containerOne" href="#" target="_blank">
