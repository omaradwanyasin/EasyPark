...
//             <ul className='col'>
//               <Link to="/AboutUs">
//               <li><a href="#" style={{marginBottom:'10px'}}>about us</a></li>
//               </Link>
//               <Link to="/service">
//               <li><a href="#" style={{marginBottom:'10px'}}>our services</a></li>
//               </Link>
//               <Link to="/Policy">
//               <li><a href="#" style={{marginBottom:'10px'}}>Policy</a></li>
...
//         <div class="card">
//           <a class="socialContainer containerOne" href="https://www.instagram.com/easypark2024/" target="_blank">
...
//           <a class="socialContainer containerTwo" href="https://twitter.com/park_easy77" target="_blank">
...
//         {/*     
//           <a class="socialContainer containerThree" href="#" target="_blank">
...
//           <a class="socialContainer containerFour" href="tel:+970595665021" target="_blank">
  ...
  return (
    ...
    <div className='footerContainer'>
      <div className='social'>
        <a href="https://www.instagram.com/easypark2024/" target="_blank">
            <i class="fa-brands fa-instagram"></i>
          </a>

          <a href="https://twitter.com/park_easy77" target="_blank">
          <i class="fa-brands fa-twitter"></i>
          </a>

            <a href="tel:+970595665021" target="_blank">
      ...
      <div className="footerButtom">
        <p>Copyright &copy;2024 <span className='team'>EasyPark</span></p>
      </div>
    </div>
    </footer>
  )
